...
Design drafts for Kedger currently live under this hackathon repo’s `docs/` until the Kedger repo exists. That co-location is temporary storage of docs — **not** a merge of the two products.
...
## 5. Repo creation (blocked on human)

This agent’s GitHub token cannot create repositories.

Please create an empty repo named **`kedger`** (separate from MoDeX / `google-hackathon`), then say “migrate now.”

---

## 6. Immediate next implementation step (once Kedger repo exists)
